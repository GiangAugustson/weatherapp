...
public class DisplayScreenController{
    ...
    //String location = UpdateLocationController.getLocation();
    WeatherAPI w = new WeatherAPI("Okay");
    //WeatherAPI w = new WeatherAPI(location);

    //Set default values for display screen using Laurel, MD
